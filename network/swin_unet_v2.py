...
class WindowAttention(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        # Swin v2, Scaled cosine attention
        qk = q @ k.transpose(-2, -1)  # [bs*num_window=1*64,num_heads=4,49,49] -> [bs*num_window=1*16,num_heads=8,49,49] -> [bs*num_window=1*4,num_heads=16,49,49] -> [bs*num_window=1*1,num_heads=32,49,49]
